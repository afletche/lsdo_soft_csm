...
subset_indices = [0, 3, 7, 10, 13, 15, 16]
bending_angles = bending_angles[subset_indices]
pressures = pressures[subset_indices]
...
subset_indices = [0, 2, 4, 7, 10, 12, 13]
bending_angles = bending_angles[subset_indices]
pressures = pressures[subset_indices]
...
# region Optimization
E_dragon.set_as_design_variable(lower=1.8e5, upper=1.e7, scaler=1.e-5)
nu_dragon.set_as_design_variable(lower=0.25, upper=0.499, scaler=1.e1)
E_fr4.set_as_design_variable(lower=3.e8, upper=24.e9, scaler=1.e-8)
