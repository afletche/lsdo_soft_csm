...
msh = meshio.read("examples/advanced_examples/big_robotic_fish/meshes/big_module_10mm.msh")
rotation_matrix_90_around_y_axis = np.array([[0, 0, -1], [0, 1, 0], [1, 0, 0]])
msh.points = np.dot(msh.points, rotation_matrix_90_around_y_axis)
...
meshio.write("examples/advanced_examples/big_robotic_fish/meshes/big_module_10mm.xdmf", meshio.Mesh(points=msh.points/1000, cells={"tetra": cells}))
...
meshio.write("examples/advanced_examples/big_robotic_fish/meshes/big_module_10mm_left_chamber_inner_surfaces.xdmf", meshio.Mesh(points=msh.points/1000, cells={"triangle": cells},
                                    cell_data={"left_chambers": [cell_data]}))
...
meshio.write("examples/advanced_examples/big_robotic_fish/meshes/big_module_10mm_right_chamber_inner_surfaces.xdmf", meshio.Mesh(points=msh.points/1000, cells={"triangle": cells}, 
                                    cell_data={"right_chambers": [cell_data]}))
