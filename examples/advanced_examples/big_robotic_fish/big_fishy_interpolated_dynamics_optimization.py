...
def import_geometry() -> lfs.Function:
    with open("examples/advanced_examples/big_robotic_fish/big_fish.pickle", 'rb') as handle:
...
fishy.name = 'fishy'
fishy.coefficients.reshape((41,15,15,3))
# fishy.plot()

# endregion Import and Setup

# region -Structural Mesh Projection
mesh_file_path = "examples/advanced_examples/big_robotic_fish/meshes/"
...
panel_mesh_this_timestep = fishy.evaluate(panel_method_parametric_mesh, plot=True)
...
structural_displacements, applied_work, new_mesh_cooordinates = lsdo_soft_csm.big_robotic_fish_static_structural_model(structural_mesh_displacements, pump_pressure,
...
actuation_frequency.set_as_design_variable(lower=0.2, upper=1., scaler=1.e1)
