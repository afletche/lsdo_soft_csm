...
msh = meshio.read("examples/advanced_examples/big_robotic_fish/meshes/big_v1_fine.msh")
mesh_nodes = msh.points/1000
rotation_matrix_90_around_y_axis = np.array([[0, 0, -1], [0, 1, 0], [1, 0, 0]])
mesh_nodes = np.dot(mesh_nodes, rotation_matrix_90_around_y_axis)
...
# Create an enclosure volume around the mesh
enclosure_volume = lfs.create_enclosure_block(points=mesh_nodes, num_coefficients=(41,15,15), degree=(2,2,2))
...
fishy_function_space = lfs.BSplineSpace(num_parametric_dimensions=3, degree=(2,2,2), coefficients_shape=(41,15,15))
...
file_name = "examples/advanced_examples/big_robotic_fish/big_fish.pickle"
